...
> Во всём исходном коде добавлены **подробные комментарии** (C#, Razor, JS, CSS) — классы, методы, функции и ключевые блоки логики пояснены для обучения и сдачи экзамена.
